...
void compute_rotation() //@@IMPD Whole Function
{
...
void compute_translation()
{
    ...
    float xx = current_position.x - initial_position.x; //@@IMPD
    float yy = current_position.y - initial_position.y; //@@IMPD
    translation_done = sqrt(xx*xx + yy*yy); //@@IMPD
    error_translation = translation_to_do - translation_done; //@@IMPD
...
void combine_rotation_and_translation()
{
    ...
    translation_speed = translation_speed * coef_translation;//@@IMPD
